...
from models.utils import get_rc_tensor
...
def to_atom37(trans, rots):
    ...
    return final_atom37#torch.Size([1, 505, 37, 3])
...
def atom37_to_atom14(aatype, all_atom_pos, all_atom_mask):
    ...
    residx_atom14_to_atom37 = get_rc_tensor(residue_constants.RESTYPE_ATOM14_TO_ATOM37, aatype)
    no_batch_dims = len(aatype.shape)
    atom14_mask = model_utils.batched_gather(
        all_atom_mask,
