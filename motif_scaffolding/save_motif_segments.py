...
def load_contig_test_case(row):
    ...
    contig_test_case = {
        "motif_segments": motif_segments, #[(20, 7), (20, 7)]
        "contig": motif_contig,#'5-20,A16-35,10-25,A52-71,5-20'
        "sampled_contig": sample_contig,#['18-18,A16-35,24-24,A52-71,16-16']
        "motif_locations": motif_locations,#[(18, 37), (62, 81)]
        "total_length": total_length,#98
