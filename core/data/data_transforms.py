...
from core.np import residue_constants as rc
from core.utils.rigid_utils import Rotation, Rigid
from core.utils.tensor_utils import (
    tree_map,
    tensor_tree_map,
    batched_gather,
)
...
def make_msa_feat(protein):
    ...
    # compatibility with domain processed_ppi.
...
def atom37_to_torsion_angles(
    ...
    # print(f'torsion_angles_sin_cos.dtype: {torsion_angles_sin_cos.dtype}')
    return protein
